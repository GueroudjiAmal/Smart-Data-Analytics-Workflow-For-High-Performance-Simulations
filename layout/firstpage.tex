...
\begin{textblock}{100}(0,0)
    \includegraphics [angle=-90,scale=0.8]{media/bande.png}
    \vspace{300mm}
\end{textblock}
...
\begin{textblock}{1}(\hpos,\vpos)
	\textblockcolour{white}
		\includegraphics[scale=1]{media/etab/uga.jpg}	
\end{textblock}
...
\begin{textblock}{10}(5.7,3)
	...
	\begin{flushright}
		...
		\normalsize {Thèse de doctorat de l'Université de Grenoble Alpes} \\
